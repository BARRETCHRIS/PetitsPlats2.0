...
// import FiltersItemTemplate from '../templates/FiltersItemTemplate.js';
// import { FilteredDataApi } from '../main.js'; // Import de FilteredDataApi au lieu de DatasApi
...
//     updateLists() {
//         this.updateList(this.filteredItem.length > 0 ? this.filteredItem : FilteredDataApi.getItemsByType(this.type)); // Utilisation de FilteredDataApi au lieu de DatasApi
//     }
